...
from modules import train_model_cls, validate_model_cls
...
def main(args):
    ...
    for i in range(epoch_start, epoch_end):
        # train the model
        train_loss, train_acc = train_model_cls(i, model, SEM_train_load, fn_loss, optimizer)
        # # # # # Validation every 5 epoch
        if (i+1) % 5 == 0:
            val_acc, val_loss = validate_model_cls(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root_path', type=str, default='/HDD/dataset/doosan/total_img/')
    parser.add_argument('--image_path', type=str, default='/HDD/dataset/doosan/total_img/img_random')
    parser.add_argument('--mask_path', type=str, default='/HDD/dataset/doosan/total_img/inference_images')
    parser.add_argument('--save_dir', type=str, default='/HDD/jungmin/doosan/history/total/')
