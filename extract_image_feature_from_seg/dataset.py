...
class CustomDatasetTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print('_'.join(single_image_name.split('_')[:-1]))
        # if '_'.join(single_image_name.split('_')[:-1]) in eta_list:
        ...
        # th, dst = cv2.threshold(img_as_np, otsu_threshold, 255, cv2.THRESH_BINARY)
